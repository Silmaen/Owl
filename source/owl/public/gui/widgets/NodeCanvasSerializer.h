...
/**
 * @brief YAML serialization helpers for `NodeCanvas`.
 *
...
public:
	...
	/// @brief Serialize the canvas to a YAML string.
	...
	/// @brief Populate a canvas from a YAML string.
	...
	/// @brief Write the canvas to a file on disk.
	/// @param[in] iCanvas The canvas to snapshot.
	...
	/// @brief Load a canvas from a file on disk.
	...
	/// @brief Serialize a subset of the canvas (clipboard use case).
	/// @param[in] iCanvas The canvas to snapshot.
	...
	/// @brief Paste a serialized subset into a canvas, generating fresh UUIDs for every node/pin/link.
