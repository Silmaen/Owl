...
/**
 * @brief Helper utilities for playing sounds from gameplay code.
 */
class OWL_API SoundHelper final {
public:
	/**
	 * @brief Play the sound attached to an entity's SoundSource component.
	...
	/**
	 * @brief Stop the sound attached to an entity's SoundSource component.
	 * @param[in,out] iEntity The entity with a SoundSource component.
	 */
