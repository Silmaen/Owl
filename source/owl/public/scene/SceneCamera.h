...
/**
 * @brief
 *  Class describing a camera in the scene.
 */
...
public:
	...
	/**
	 * @brief
	 *  Defines perspective parameters.
	...
	/**
	 * @brief
	 *  Get the orthographic near clip distance.
	...
	/**
	 * @brief
	 *  Defines orthographic near clip distance.
	...
	/**
	 * @brief
	 *  Get the orthographic far clip distance.
	...
	/**
	 * @brief
	 *  Defines orthographic far clip distance.
	...
	/**
	 * @brief
	 *  Defines perspective vertical field of view.
	...
	/**
	 * @brief
	 *  Get the perspective near clip distance.
	...
	/**
	 * @brief
	 *  Defines perspective near clip distance.
	 * @param[in] iNearClip New distance for near clipping.
	 */
	...
	/**
	 * @brief
	 *  Get the perspective far clip distance.
	...
	/**
	 * @brief
	 *  Defines perspective far clip distance.
	 * @param[in] iFarClip New distance for far clipping.
	 */
