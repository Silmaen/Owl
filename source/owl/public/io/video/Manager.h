...
/**
 * @brief
 *  Class managing the video input devices.
 */
...
public:
	...
	/**
	 * @brief
	 *  Get the number of found devices.
	...
	/**
	 * @brief
	 *  Request a refresh of the devices list.
	...
	/**
	 * @brief
	 *  Get an ordered list of device names.
	...
	/**
	 * @brief
	 *  Access to the current device id.
	...
	/**
	 * @brief
	 *  Check if some devices exist in the list.
	...
	/**
	 * @brief
	 *  Open the device with the selected id.
	...
	/**
	 * @brief
	 *  Grab a frame and put it into the Texture.
