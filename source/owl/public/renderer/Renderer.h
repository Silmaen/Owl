...
public:
	...
	/**
	 * @brief
	 *  Initialize the renderer (context + shaders in one call).
	 */
	static void init();

	/**
	 * @brief
	 *  Initialize the rendering context only (no shader compilation).
	 *
	...
	/**
	 * @brief
	 *  Install the active renderer stack (called when scenes activate).
	 *
	...
	/**
	 * @brief
	 *  Access the active renderer stack (may be empty).
