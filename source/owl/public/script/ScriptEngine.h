...
/**
 * @brief Namespace for scripting.
 */
namespace owl::script {

/**
 * @brief Types of exposed script properties.
 */
...
/**
 * @brief A single exposed script property.
 */
...
/**
 * @brief Global script engine manager (singleton pattern).
 *
...
public:
	...
	/**
	 * @brief Shut down the scripting engine and release resources.
	 */
	static void shutdown();

	/**
	 * @brief Check whether the engine is initialized.
	 * @return True if initialized.
	 */
	[[nodiscard]] static auto isInitialized() -> bool;

	/**
	 * @brief Load a Lua script from a file.
	...
	/**
	 * @brief Load a Lua script from a memory buffer.
	...
	/**
	 * @brief Parse a script file to extract declared properties.
	 * @param[in] iPath Path to the .lua file.
	...
	/**
	 * @brief Parse a script buffer to extract declared properties.
	 * @param[in] iData Buffer containing the Lua source code.
	 * @param[in] iName Chunk name for error messages.
	 * @return List of extracted properties.
	 */
	...
	/**
	 * @brief Access the active scene (used internally by Lua bindings).
