...
/**
 * @brief
 *  Class for managing Vulkan physical device capabilities.
 */
...
public:
	...
	/**
	 * @brief
	 *  Get a simple string describing the device.
	...
	/**
	 * @brief
	 *  Get a detailed string describing the device.
	...
	/**
	 * @brief
	 *  Get a string describing the device capabilities.
	 * @return The device name and some details.
	 */
