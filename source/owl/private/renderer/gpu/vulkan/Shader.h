...
/**
 * @brief
 *  Specialized class managing Vulkan shader.
 */
class OWL_API Shader final : public owl::renderer::gpu::Shader {
public:
...
private:
	/**
	 * @brief
	 *  Build the Vulkan shader modules from a Slang source string.
	 * @param[in] iSlangSource The Slang shader source code.
	 */
