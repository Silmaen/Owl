...
Shader::Shader(const std::string &iShaderName, const std::string &iRenderer, const std::string &,
               const std::string &) : renderer::gpu::Shader{iShaderName, iRenderer} {}

Shader::Shader(const std::string &iShaderName, const std::string &iRenderer,
               const std::unordered_map<ShaderType, std::string> &) : renderer::gpu::Shader{iShaderName, iRenderer} {}

Shader::Shader(const std::string &iShaderName, const std::string &iRenderer,
               const std::vector<std::filesystem::path> &) : renderer::gpu::Shader{iShaderName, iRenderer} {}
