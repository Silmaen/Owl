...
public:
	...
	/**
	 * @brief Construct after an entity has already been created.
...
/**
 * @brief Command for deleting a single entity (children reparented to grandparent).
 *
...
public:
	...
	/**
	 * @brief Construct before an entity is destroyed.
...
/**
 * @brief Command for deleting an entity and all its descendants.
 *
...
public:
	...
	/**
	 * @brief Construct before a subtree is destroyed.
...
/**
 * @brief Command for duplicating a single entity.
 *
...
public:
	...
	/**
	 * @brief Construct after an entity has been duplicated.
...
/**
 * @brief Command for duplicating an entity subtree.
 *
...
public:
	...
	/**
	 * @brief Construct after a subtree has been duplicated.
