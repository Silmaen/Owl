...
/**
 * @brief
 *  Known languages handled by the editor. Unknown extensions default to `PlainText`.
 */
...
/**
 * @brief
 *  Attach the chosen language to a `TextEditor`. Built-ins (Lua/C/Cpp/Python/Json/
