...
- **v0.5.0** (Expected 2028-06-01) — Modding, level streaming, asset pipeline/cooking, platform expansion (Web/WASM, Android, gamepad)

Profiling tools and rendering optimizations are cross-cutting concerns worked on continuously across all releases.

**Why:** v0.0.3 completed the engine core. Roadmap focuses on progressively making Owl a complete game development platform.
